...
# PRODUCTION (prod-*)
# =============================================================================
prod-deploy: tf-sync-object-storage arena-images-upload-prod arena-sounds-upload-prod ## Deploy to production server
	@$(SCRIPTS_DIR)/deploy.sh

prod-deploy-skip-build: tf-sync-object-storage arena-images-upload-prod arena-sounds-upload-prod ## Deploy using existing images (skip build)
	@$(SCRIPTS_DIR)/deploy.sh --skip-build

prod-deploy-skip-cleanup: tf-sync-object-storage arena-images-upload-prod arena-sounds-upload-prod ## Deploy without cleaning up old images
