...
Cryptographically secure random key for Flask session encryption.
...
The Flask secret key is missing or invalid.

**Fix:** Generate with `make secrets-dashboard`
