...
echo ""
echo "To restore this backup to your local dev environment:"
echo ""
echo "  1. Run: make prepare-restore-db BACKUP=$LOCAL_BACKUP_DIR/$RESTORE_FILE"
echo "  2. Run: make up (this will restore the database)"
echo "  3. Run: make disable-restore-db (to prevent re-restoration on next startup)"
echo ""
